...
\anote
作为补充（详见\href{https://zhuanlan.zhihu.com/p/68763358}{该篇文章}），对于任意两个复数 $x=(a,b),\ y=(c,d)$ 的四则运算：
...
可以发现 $z_1 \cdots z_2$ 计算后模为两个复数模的乘积 $|z_1||z_2|$，幅角为两个复数幅角之和 $\arg(z_1z_2)=\arg(z_1)+\arg(z_2)$。
